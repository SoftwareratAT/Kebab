...
public final class Schematic {
    ...
    public static KebabWorld toWorld(String name, Environment environment, CompoundTag nbt) {
        ...
        KebabWorld world = new KebabWorld(name, environment, width, length);
        ...
        while (i < blockdata.length) {
            ...
            Chunk chunk = world.getChunkAtWorldPos(x, z).orElse(null);
        ...
        if (world.hasSkyLight()) {
            world.getSkyLightEngine().updateWorld();
        }
