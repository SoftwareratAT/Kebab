...
public final class KebabDataWatcher {
    private final KebabEntity entity;
    private Map<Field, WatchableObject> values;

    public KebabDataWatcher(KebabEntity entity) {
        this.entity = entity;
    ...
    public synchronized Map<Field, WatchableObject> update() throws IllegalArgumentException, IllegalAccessException {
        ...
        for (Map.Entry<Field, WatchableObject> entry : values.entrySet()) {
